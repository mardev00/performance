...
public class SingleThreadedImperative {
	...
	public static void main(String[] args) {
		...
		SingleThreadedImperative example = new SingleThreadedImperative();
...
//					  combinedStream.collect(Collectors.toList());
			...
			Thread.sleep(sleep2);	
			System.out.println("Total Imperative: " + example.calculateImperative(users));
	...
	public double calculateImperative(List<User> users) {
		//calculate Users orders
		System.out.println("---------------------------------");
		System.out.println("IMPERATIVE START");
		long start = System.currentTimeMillis();
		double total = 0.0;
		for(User u: users) {
			List<Order> userOrders = u.orders;
		...
		long perf = end - start;
		System.out.println("IMPERATIVE DONE IN " + perf);
		System.out.println("---------------------------------");
		return total;
	}
